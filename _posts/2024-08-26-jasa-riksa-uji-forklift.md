...
howto_post:
  ...
  steps:
    - name: "Persiapan Sebelum Riksa Uji"
      text: "Pengumpulan dokumen seperti manual book, sertifikat sebelumnya, dan maintenance record. Persiapan peralatan uji yang diperlukan."
    - name: "Pemeriksaan Visual"
      text: "Inspeksi kondisi fisik forklift meliputi body, fork, mast, ban, lampu, dan komponen keselamatan."
    - name: "Uji Fungsi Forklift"
      text: "Pengujian sistem angkat (lifting), tilting, dan side shift. Pengecekan fungsi hidrolik dan responsivitas kontrol."
    - name: "Uji Keselamatan"
      text: "Testing sistem peringatan, rem (service, parking, emergency), dan komponen safety lainnya."
    - name: "Dokumentasi Hasil"
      text: "Pencatatan semua temuan inspeksi, foto dokumentasi, dan pembuatan laporan detail."
    - name: "Tindak Lanjut"
      text: "Pelaksanaan perbaikan jika ditemukan masalah dan penerbitan sertifikat jika forklift lulus uji."
...
# Section 1: Pentingnya Riksa Uji Forklift
    ...
    - title: "Memperpanjang Umur Forklift"
      ...
      bullets:
        ...
        - key: "Penggantian Komponen yang Tepat Waktu"
          value: "Identifikasi komponen yang perlu diganti dapat membantu menjaga forklift dalam kondisi optimal."

# Section 2: Proses Riksa Uji Forklift
        ...
        - title: "Peralatan Uji"
          bullets:
            ...
            - key: "Alat Pelindung Diri (APD)"
              value: "Semua personel yang terlibat dalam proses riksa uji harus menggunakan APD yang sesuai, seperti helm, sepatu keselamatan, dan sarung tangan, untuk melindungi diri dari potensi bahaya."
...
section_training:
  ...
  description: "Sertifikasi operator forklift adalah kewajiban yang diatur dalam peraturan K3 untuk memastikan setiap operator memiliki kompetensi yang memadai dalam mengoperasikan forklift dengan aman."
  cards_heading: "Program Sertifikasi dan Materi Pelatihan"
  cards_intro: "Berikut adalah komponen utama dalam program pelatihan dan sertifikasi operator forklift yang harus dipahami:"
  ...
  summary: "Dengan mengikuti program pelatihan dan sertifikasi yang tepat, operator forklift dapat bekerja dengan aman, efisien, dan sesuai standar K3 yang berlaku."
  cards:
    ...
    - title: "Materi Pelatihan"
      icon: "bi-book"
      content: "Pelatihan untuk sertifikasi operator forklift mencakup berbagai materi, termasuk identifikasi dan penilaian risiko, prosedur penanganan material, pemeliharaan dasar forklift, serta teknik pengoperasian yang benar."
    - title: "Proses Ujian Sertifikasi"
      icon: "bi-clipboard-check"
      content: "Proses sertifikasi biasanya diakhiri dengan ujian, yang meliputi tes tertulis dan evaluasi keterampilan praktis. Setelah lulus ujian, operator akan mendapatkan sertifikat kompetensi."
    - title: "Keuntungan Sertifikasi"
      icon: "bi-graph-up-arrow"
      content: "Memiliki sertifikasi operator forklift tidak hanya penting dari segi kepatuhan hukum, tetapi juga memberikan keuntungan bagi perusahaan dalam hal keselamatan dan efisiensi operasional."
    - title: "Pelatihan Berkala"
      icon: "bi-arrow-repeat"
      content: "Pelatihan tidak hanya dilakukan satu kali. Pelatihan berkala sangat penting untuk memperbarui pengetahuan operator seiring perkembangan teknologi dan peraturan."
    - title: "Durasi dan Biaya"
      icon: "bi-clock-history"
      content: "Program pelatihan umumnya berlangsung 2-5 hari tergantung jenis forklift dan tingkat pengalaman peserta. Biaya bervariasi sesuai dengan lembaga penyelenggara dan fasilitas yang disediakan."
  bullets_intro: "Pelatihan operator adalah faktor penting yang tidak boleh diabaikan. Operator yang terlatih dengan baik dapat:"
  bullets:
    ...
    - title: "Proses Pengesahan Gambar Forklift"
      ...
      items:
        ...
        - title: "Pemeriksaan Kelayakan"
          icon: "bi-search"
          content: "Forklift akan diperiksa secara fisik untuk memastikan bahwa konstruksi dan komponennya sesuai dengan gambar yang telah disahkan dan memenuhi standar keselamatan."
        - title: "Penerbitan Sertifikat"
          icon: "bi-award"
          content: "Jika forklift lolos pengujian dan verifikasi, akan diterbitkan sertifikat pengesahan gambar, yang menunjukkan bahwa forklift tersebut layak untuk digunakan."
    - title: "Pentingnya Pengesahan Gambar Forklift"
      icon: "bi-exclamation-circle"
      items:
        - title: "Keselamatan"
          icon: "bi-shield-check"
          content: "Pengesahan gambar memastikan bahwa forklift dirancang dan dibangun dengan standar keselamatan yang tinggi, mengurangi risiko kecelakaan kerja."
  ...
  topics:
    - title: "Pentingnya SLO Forklift"
      ...
      bullets:
        ...
        - key: "Kepatuhan"
          value: "Mematuhi peraturan perundang-undangan yang berlaku, khususnya terkait keselamatan dan kesehatan kerja."
        - key: "Legalitas"
          value: "SLO adalah bukti bahwa forklift dioperasikan secara legal dan sesuai dengan standar yang ditetapkan."
        - key: "Kepercayaan"
