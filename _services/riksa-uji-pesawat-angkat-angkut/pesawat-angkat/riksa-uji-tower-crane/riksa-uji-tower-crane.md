...
para_1: Riksa uji tower crane adalah pemeriksaan serta pengujian kepada pesawat angkat
  jenis menara sesuai secara cara Permenaker No. 8 Tahun 2020 mengenai Keselamatan
...
intro:
  ...
  para: PT. Cipta Mas Jaya menyediakan layanan riksa uji tower crane secara cara cara
    cara cara inspector bersertifikat serta berpengalaman. Kami memverifikasi tower
  ...
  - h3: Dasar Hukum dan Standar Keselamatan
    para: Riksa uji tower crane wajib dilaksanakan berdasarkan regulasi keselamatan
    ...
    - h4: Permenaker No. 8 Tahun 2020
      para: Peraturan Menteri Ketenagakerjaan tentang Keselamatan serta Kesehatan
        ...
        rangka semua jenis crane termasuk tower crane.
    - h4: Standar FEM dan ISO
      para: Pengujian dijalankan mengacu terhadap kriteria internasional FEM (Federation
  ...
  - h3: Tim Inspector Bersertifikat
    para: Tim inspector kami memiliki sertifikat kompetensi daripada BNSP dan telah
      ...
      meliputi bermacam-macam jenis tower crane dalam rangka proyek konstruksi gedung
      dan infrastruktur.
  - h3: Cakupan Layanan Nasional
    para: Kami melayani riksa uji tower crane terhadap seluruh Indonesia, daripada
      proyek konstruksi gedung bertingkat, jembatan, sampai infrastruktur besar. Tim
      kami siap datang ke lokasi proyek Anda kapanpun dibutuhkan.
jenis_alat:
...
komponen_inspeksi:
  ...
  description: Pengecekan menyeluruh kepada semua komponen keselamatan tower crane
  items:
  - name: Mast dan Tower Section
    description: Pengecekan struktur menara, sambungan antar section, baut pengikat,
      serta keadaan las terhadap korosi atau deformasi.
    icon: bi-building
  - name: Slewing Unit
    description: Pemeriksaan mekanisme putar mencakup slewing ring, motor slewing,
  ...
  - name: Hoisting Mechanism
    description: Inspeksi winch, drum, wire rope, hook block, dan sistem brake hoist
      dalam rangka menjamin fungsi pengangkatan aman.
    icon: bi-arrow-up-circle
  - name: Cabin dan Sistem Kontrol
    description: Pengecekan kondisi cabin operator, panel kontrol, joystick, display,
