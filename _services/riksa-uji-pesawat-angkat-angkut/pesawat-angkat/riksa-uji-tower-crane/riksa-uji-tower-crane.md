...
para_1: Riksa uji tower crane adalah inspeksi dan pengujian terhadap pesawat angkat
...
intro:
  ...
  - h3: Dasar Hukum dan Standar Keselamatan
    para: Riksa uji tower crane wajib dilaksanakan berdasarkan regulasi keselamatan
      kerja yang berlaku pada Indonesia untuk menjamin keamanan operasional pada proyek
      konstruksi.
    subsections:
    ...
    - h4: Standar FEM dan ISO
      para: Pengujian dilakukan mengacu pada kriteria internasional FEM (Federation
  ...
  - h3: Tim Inspector Bersertifikat
    para: Tim inspector kami mempunyai sertifikat kompetensi daripada BNSP dan telah
      ...
      termasuk beragam jenis tower crane untuk proyek konstruksi gedung dan infrastruktur.
  - h3: Cakupan Layanan Nasional
    para: Kami melayani riksa uji tower crane pada semua Indonesia, dari proyek konstruksi
...
komponen_inspeksi:
  ...
  description: Pengecekan menyeluruh pada seluruh elemen keselamatan tower crane
  items:
  ...
  - name: Jib dan Counter-Jib
    description: Pengecekan keadaan lengan horizontal, sambungan, trolley rail, dan
