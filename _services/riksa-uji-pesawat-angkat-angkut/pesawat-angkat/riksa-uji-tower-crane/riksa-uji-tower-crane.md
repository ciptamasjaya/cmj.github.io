...
para_1: Riksa uji tower crane adalah pemeriksaan serta pengujian terhadap pesawat
  angkat jenis menara berdasarkan secara Permenaker No. 8 Tahun 2020 mengenai Keselamatan
...
intro:
  ...
  para: PT. Cipta Mas Jaya menyediakan layanan riksa uji tower crane dengan cara inspector
    bersertifikat dan berpengalaman. Kami memverifikasi tower crane Anda memenuhi
  ...
  - h3: Dasar Hukum dan Standar Keselamatan
    ...
    - h4: Permenaker No. 8 Tahun 2020
      para: Peraturan Menteri Ketenagakerjaan mengenai Keselamatan serta Kesehatan
        ...
        rangka segenap jenis crane termasuk tower crane.
    - h4: Standar FEM dan ISO
      para: Pengujian dilakukan mengacu terhadap acuan internasional FEM (Federation
        ...
        Acuan Nasional Indonesia (SNI) yang berlaku.
...
komponen_inspeksi:
  ...
  description: Inspeksi menyeluruh kepada semua komponen keselamatan tower crane
  items:
  - name: Mast dan Tower Section
    description: Inspeksi struktur menara, sambungan antar section, baut pengikat,
      serta keadaan las terhadap korosi maupun deformasi.
    icon: bi-building
  - name: Slewing Unit
