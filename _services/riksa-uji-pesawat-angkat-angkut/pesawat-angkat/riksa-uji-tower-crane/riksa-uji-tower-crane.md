...
para_1: Riksa uji tower crane adalah inspeksi dan pengujian pada pesawat angkat jenis
  menara sesuai dengan cara Permenaker No. 8 Tahun 2020 tentang Keselamatan dan Kesehatan
...
intro:
  ...
  para: PT. Cipta Mas Jaya menyediakan layanan riksa uji tower crane dengan cara cara
    cara inspector bersertifikat dan berpengalaman. Kami menjamin tower crane Anda
...
komponen_inspeksi:
  ...
  description: Pemeriksaan menyeluruh pada segenap komponen keselamatan tower crane
  items:
  - name: Mast dan Tower Section
    ...
    icon: bi-building
  - name: Slewing Unit
    description: Pemeriksaan mekanisme putar meliputi slewing ring, motor slewing,
      serta sistem pengereman rotasi.
    icon: bi-arrow-repeat
  - name: Jib dan Counter-Jib
    description: Pemeriksaan situasi lengan horizontal, sambungan, trolley rail, serta
