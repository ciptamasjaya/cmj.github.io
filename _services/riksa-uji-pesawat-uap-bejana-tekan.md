...
intro:
  ...
  para_1: Apa yang dimaksud dengan riksa uji pesawat uap bejana tekan dan tangki timbun?
    ...
    Menteri Ketenagakerjaan. Inspeksi ini wajib dilakukan untuk memverifikasi peralatan
  ...
  para_2: PT. Cipta Mas Jaya sebagai PJK3 (Perusahaan Jasa Keselamatan serta Kesehatan
    ...
    listrik, serta pengolahan migas untuk menjamin keselamatan operasional serta compliance
    kepada regulasi pemerintah.
jenis_layanan:
...
mengapa_penting:
  ...
  para: Riksa uji pesawat uap bejana tekan bukan hanya kewajiban regulasi, tetapi
    ...
    serta kerugian finansial besar. Pengecekan berkala menjamin segenap bagian kritis
    seperti dinding bejana, safety valve, sistem kontrol tekanan, serta welding integrity
    bekerja optimal sesuai spesifikasi pabrikan serta kriteria keselamatan ASME, API,
    serta SNI.
proses_riksa_uji:
