...
para_1: Riksa uji boiler merupakan inspeksi serta tes keselamatan terhadap ketel uap
  yang wajib dijalankan secara cara berkala berdasarkan Peraturan Menteri Ketenagakerjaan
  Nomor 37 Tahun 2016. Inspeksi ini ditujukan dalam rangka memverifikasi boiler bekerja
  secara cara aman serta berdasarkan acuan keselamatan kerja yang berlaku.
...
intro:
  ...
  para: PT. Cipta Mas Jaya sebagai PJK3 (Perusahaan Jasa Keselamatan serta Kesehatan
    ...
    layanan riksa uji boiler yang komprehensif secara cara cara cara tim inspector
    bersertifikat serta peralatan testing yang terkalibrasi.
  subsections:
  - h3: Dasar Hukum dan Standar Keselamatan
    ...
    - h4: ASME dan Standar Internasional
      para: Pada samping mengacu kepada peraturan nasional, kami juga menerapkan acuan
        ASME Boiler and Pressure Vessel Code dan acuan internasional lainnya dalam
  ...
  - h3: Tim Inspector Bersertifikat
    para: Inspector kami mempunyai sertifikasi resmi daripada Kementerian Ketenagakerjaan
      ...
      dalam bidang pengecekan boiler. Setiap pengecekan dilakukan dengan cara cara
...
komponen_inspeksi:
  ...
  - name: Drum Uap
    ...
    icon: bi-circle
  - name: Pipa Pemanas
    description: Pengecekan kondisi tube, deteksi korosi, dan pengukuran ketebalan
      dinding
    icon: bi-diagram-3
