...
para_1: Riksa uji boiler merupakan inspeksi serta tes keselamatan terhadap ketel uap
  ...
  37 Tahun 2016. Pemeriksaan ini bertujuan dalam rangka memverifikasi boiler beroperasi
...
intro:
  ...
  para: PT. Cipta Mas Jaya sebagai PJK3 (Perusahaan Jasa Keselamatan serta Kesehatan
    ...
    menyediakan layanan riksa uji boiler yang komprehensif dengan cara cara tim inspector
    bersertifikat serta perkakas testing yang terkalibrasi.
  subsections:
  - h3: Dasar Hukum dan Standar Keselamatan
    para: Tiap pemeriksaan riksa uji boiler yang kami lakukan mengacu kepada regulasi
      serta kriteria keselamatan kerja yang berlaku di Indonesia, menjamin kepatuhan
...
komponen_inspeksi:
  ...
  description: Pengecekan menyeluruh kepada seluruh bagian keselamatan boiler
  items:
  - name: Drum Uap
  ...
  - name: Sistem Kontrol
    description: Pengecekan manometer, termometer, level gauge, dan sistem kontrol
      otomatis
    icon: bi-sliders
  - name: Sistem Isolasi
