...
para_1: Riksa uji boiler merupakan inspeksi serta tes keselamatan terhadap ketel uap
  yang wajib dilaksanakan secara berkala berdasarkan Peraturan Menteri Ketenagakerjaan
  Nomor 37 Tahun 2016. Pemeriksaan ini bertujuan dalam rangka memverifikasi boiler
  beroperasi secara aman serta berdasarkan kriteria keselamatan kerja yang berlaku.
...
intro:
  ...
  para: PT. Cipta Mas Jaya sebagai PJK3 (Perusahaan Jasa Keselamatan dan Kesehatan
    ...
    menyediakan layanan riksa uji boiler yang komprehensif secara cara cara tim inspector
    bersertifikat dan perkakas testing yang terkalibrasi.
  subsections:
  - h3: Dasar Hukum dan Standar Keselamatan
    para: Masing-masing pemeriksaan riksa uji boiler yang kami lakukan mengacu kepada
      regulasi serta kriteria keselamatan kerja yang berlaku di Indonesia, menjamin
    ...
    - h4: Permenaker No. 37 Tahun 2016
      para: Peraturan Menteri Ketenagakerjaan Nomor 37 Tahun 2016 mengenai Keselamatan
        serta Kesehatan Kerja Bejana Tekanan serta Tangki Timbun mewajibkan tiap boiler
    ...
    - h4: ASME dan Standar Internasional
      para: Selain mengacu kepada peraturan nasional, kami juga menerapkan kriteria
        ASME Boiler and Pressure Vessel Code dan kriteria internasional lainnya dalam
        rangka memastikan kualitas pemeriksaan terbaik.
  - h3: Tim Inspector Bersertifikat
    para: Inspector kami mempunyai sertifikasi resmi daripada Kementerian Ketenagakerjaan
      RI secara kualifikasi Ahli K3 Pesawat Uap serta pengalaman bertahun-tahun dalam
      bidang inspeksi boiler. Setiap inspeksi dijalankan secara profesionalisme tinggi
      serta menghasilkan sertifikat yang diakui secara cara nasional.
  - h3: Cakupan Layanan Nasional
    para: Kami melayani beragam jenis boiler meliputi fire tube boiler, water tube
      boiler, steam generator, dan thermal oil heater pada seluruh Indonesia. Dengan
      cara jaringan inspector yang luas, kami siap melakukan inspeksi on-site pada
      lokasi Anda.
jenis_alat:
  ...
  - name: Thermal Oil Heater
    description: Pemanas dengan media oli thermal untuk aplikasi suhu tinggi
    icon: bi-thermometer-high
  - name: Economizer
    description: Alat penukar panas untuk memanaskan air umpan boiler
...
komponen_inspeksi:
  ...
  description: Pemeriksaan menyeluruh kepada semua bagian keselamatan boiler
  items:
  - name: Drum Uap
    description: Pemeriksaan integritas struktur, ketebalan dinding, dan situasi internal
      drum
    icon: bi-circle
  - name: Pipa Pemanas
    description: Pemeriksaan kondisi tube, deteksi korosi, dan pengukuran ketebalan
      dinding
    icon: bi-diagram-3
  - name: Burner dan Pembakaran
    description: Pemeriksaan fungsi burner, efisiensi pembakaran, serta sistem bahan
      bakar
    icon: bi-fire
  - name: Katup Pengaman
    description: Tes safety valve dalam rangka menjamin dapat membuka pada tekanan
      set
    icon: bi-shield-check
  - name: Sistem Kontrol
    description: Pengecekan manometer, termometer, level gauge, serta sistem kontrol
      otomatis
    icon: bi-sliders
  - name: Sistem Isolasi
    description: Pemeriksaan keadaan isolasi termal dalam rangka efisiensi dan keselamatan
    icon: bi-box
proses_inspeksi:
  ...
  - name: Pemeriksaan Dokumen
    text: Inspector memeriksa kelengkapan dokumen boiler seperti sertifikat sebelumnya,
      maintenance record, gambar teknis, dan spesifikasi unit.
  - name: Inspeksi Visual
    text: Pemeriksaan kondisi fisik boiler meliputi dinding, struktur, pipa, sambungan,
      sistem isolasi, dan komponen keselamatan.
  - name: Uji NDT (Non-Destructive Testing)
    text: Pengukuran ketebalan dinding menggunakan ultrasonic thickness gauge dan
      pemeriksaan sambungan las jika diperlukan.
  - name: Uji Hidrostatik
    text: Pengujian tekanan dengan air pada 1.5 kali tekanan kerja maksimum untuk
      memastikan integritas struktur.
  - name: Pengujian Safety Device
    text: Testing katup pengaman, alarm sistem, sensor overpressure, dan semua komponen
      keselamatan boiler.
...
cara_pemesanan:
  ...
  description: Langkah-langkah mudah untuk memesan jasa riksa uji boiler di PT. Cipta
    Mas Jaya
  totalTime: P7D
  steps:
  - name: Hubungi Kami
    text: Hubungi tim kami via WhatsApp atau telepon untuk konsultasi kebutuhan riksa
      uji boiler Anda. Kami siap menjawab pertanyaan dan memberikan informasi lengkap.
  ...
  - name: Inspeksi On-Site
    text: Inspector bersertifikat kami datang ke lokasi Anda dengan peralatan testing
      lengkap termasuk ultrasonic gauge dan pressure test equipment.
  - name: Penerbitan Sertifikat
    text: Setelah boiler lulus inspeksi, sertifikat kelayakan operasional diterbitkan
...
offer_riksa_uji:
  ...
  - name: Paket Riksa Uji Multi Unit
    description: Inspeksi untuk 3+ unit boiler dengan harga spesial
    price: 4000000
    price_currency: IDR
...
faq_riksa_uji:
  ...
  - question: Apa itu riksa uji boiler?
    answer: Riksa uji boiler adalah pemeriksaan dan pengujian keselamatan terhadap
      ketel uap yang dilakukan oleh PJK3 (Perusahaan Jasa Keselamatan dan Kesehatan
      Kerja) yang ditunjuk oleh Kementerian Ketenagakerjaan RI. Tujuannya untuk memastikan
      boiler layak dan aman dioperasikan sesuai standar K3.
  - question: Berapa tahun sekali riksa uji boiler dilakukan?
    answer: Menurut Permenaker No. 37 Tahun 2016, riksa uji boiler wajib dilakukan
      setiap 2 tahun sekali untuk perpanjangan Izin Pemakaian Pesawat Uap. Pemeriksaan
      internal dilakukan setiap 4 tahun atau sesuai rekomendasi inspector.
  - question: Apa saja yang diperiksa dalam riksa uji boiler?
    answer: 'Pemeriksaan meliputi: drum uap dan pipa pemanas, burner dan sistem pembakaran,
      katup pengaman (safety valve), sistem kontrol dan instrumentasi, uji NDT untuk
  ...
  - question: Apakah sertifikat riksa uji berlaku nasional?
    answer: Ya, sertifikat riksa uji boiler yang kami terbitkan berlaku secara nasional
      ...
      ini wajib dimiliki sebagai syarat perpanjangan Izin Pemakaian Pesawat Uap.
  - question: Berapa lama masa berlaku Izin Pemakaian Boiler?
