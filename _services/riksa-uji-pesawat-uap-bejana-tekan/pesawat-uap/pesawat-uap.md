...
intro:
  ...
  para_2: PT. Cipta Mas Jaya sebagai PJK3 (Perusahaan Jasa Keselamatan serta Kesehatan
    ...
    inspeksi on-site kepada segenap Indonesia dengan cara cara cara perkakas testing
...
layanan_pesawat_uap:
  ...
  para: Kami melayani riksa uji dalam rangka bermacam-macam jenis pesawat uap sesuai
    ...
    khusus yang mengacu pada kriteria ASME dan regulasi Kemnaker RI.
  sub_categories:
  ...
  - title: Riksa Uji Thermal Oil Heater
    description: Inspeksi pemanas dengan cara cara cara media oli thermal. Inspeksi
...
mengapa_penting:
  ...
  para: Pesawat uap berfungsi terhadap tekanan serta temperatur tinggi sehingga memiliki
    ...
    semua komponen kritis seperti tube boiler, safety valve, pressure gauge, serta
    sistem kontrol berfungsi optimal. Inspeksi ini bukan hanya kewajiban legal berdasarkan
...
proses:
  ...
  para: Tim inspector kami datang ke lokasi Anda secara cara cara cara perkakas testing
    ...
    camera. Proses pengecekan meliputi pengecekan dokumen, pengecekan visual internal
