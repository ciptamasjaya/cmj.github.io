...
layanan_pesawat_uap:
  ...
  para: Kami melayani riksa uji dalam rangka bermacam-macam jenis pesawat uap sesuai
    ...
    yang mengacu pada standar ASME dan regulasi Kemnaker RI.
  sub_categories:
...
mengapa_penting:
  ...
  para: Pesawat uap berfungsi terhadap tekanan serta temperatur tinggi sehingga mempunyai
    ...
    seluruh komponen kritis seperti tube boiler, safety valve, pressure gauge, serta
...
proses:
  ...
  para: Tim inspector kami datang ke lokasi Anda dengan cara cara cara perkakas testing
    ...
    camera. Proses inspeksi meliputi inspeksi dokumen, inspeksi visual internal serta
    eksternal, tes NDT (Non-Destructive Testing), hydrostatic test, serta functional
    test safety device. Masing-masing inspeksi didokumentasikan dalam laporan komprehensif
