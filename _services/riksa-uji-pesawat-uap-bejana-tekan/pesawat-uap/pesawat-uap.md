...
intro:
  ...
  para_1: Pesawat uap adalah perkakas yang dipakai dalam rangka menghasilkan uap bertekanan
    melalui tahapan pemanasan air. Kategori ini meliputi bermacam-macam jenis boiler,
...
layanan_pesawat_uap:
  ...
  para: Kami melayani riksa uji dalam rangka bermacam-macam jenis pesawat uap sesuai
    ...
    mengacu terhadap acuan ASME dan regulasi Kemnaker RI.
  sub_categories:
...
mengapa_penting:
  ...
  para: Pesawat uap berfungsi pada tekanan dan temperatur tinggi hingga mempunyai
    ...
    ledakan dahsyat, kebakaran, dan korban jiwa. Riksa uji berkala memastikan segenap
...
proses:
  ...
  para: Tim inspector kami datang ke lokasi Anda secara alat testing seperti ultrasonic
    ...
    meliputi pemeriksaan dokumen, inspeksi visual internal dan eksternal, tes NDT
    (Non-Destructive Testing), hydrostatic test, dan functional test safety device.
    Masing-masing inspeksi didokumentasikan dalam laporan komprehensif dan dilengkapi
