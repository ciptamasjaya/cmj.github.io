...
intro:
  ...
  para_1: Pesawat uap adalah peralatan yang digunakan dalam rangka menghasilkan uap
    bertekanan melalui proses pemanasan air. Kategori ini mencakup berbagai jenis
  ...
  para_2: PT. Cipta Mas Jaya sebagai PJK3 (Perusahaan Jasa Keselamatan dan Kesehatan
    ...
    inspeksi on-site terhadap seluruh Indonesia dengan peralatan testing terkalibrasi
...
layanan_pesawat_uap:
  ...
  para: Kami melayani riksa uji untuk beragam jenis pesawat uap sesuai kebutuhan industri
    Anda. Tiap alat memiliki proses inspeksi khusus yang mengacu pada standar ASME
...
mengapa_penting:
  ...
  para: Pesawat uap berfungsi pada tekanan dan temperatur tinggi sehingga memiliki
    potensi bahaya ledakan yang amat besar. Kegagalan perkakas dapat menyebabkan ledakan
...
proses:
  ...
  para: Tim inspector kami datang ke lokasi Anda dengan alat testing seperti ultrasonic
    thickness gauge, pressure calibrator, dan thermal imaging camera. Proses pemeriksaan
    meliputi inspeksi dokumen, pemeriksaan visual internal dan eksternal, tes NDT
